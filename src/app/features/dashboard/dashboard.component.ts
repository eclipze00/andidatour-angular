...
@Component({
  ...
  template: `
    <app-topbar [title]="'Olá, ' + userName" subtitle="Aqui está o resumo das suas cotações hoje." />
  ...
  `,
  styles: [`.search-input { height:2.75rem; border-radius:var(--radius); border:0; padding:0 0.75rem; font-size:0.875rem; background:rgba(255,255,255,0.95); color:var(--foreground); outline:none; }`]
})
